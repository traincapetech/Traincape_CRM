  ...
  return (
    <Layout>
            ...
            {!user ? (
              ...
              <div className="flex flex-wrap gap-4 justify-center sm:justify-start">
                {user.role === "Sales Person" && (
                  <Link to="/sales" className="w-full sm:w-auto px-6 py-3 bg-white text-blue-700 font-semibold rounded-lg shadow-md hover:bg-gray-100 transition text-center">
                    My Leads
                  </Link>
                )}
                {(user.role === "Lead Person" || user.role === "Manager" || user.role === "Admin") && (
                  <Link to="/leads" className="w-full sm:w-auto px-6 py-3 bg-white text-blue-700 font-semibold rounded-lg shadow-md hover:bg-gray-100 transition text-center">
                    Manage Leads
                  </Link>
                )}
                <Link to="/profile" className="w-full sm:w-auto px-6 py-3 bg-transparent border-2 border-white text-white font-semibold rounded-lg hover:bg-white hover:text-blue-700 transition text-center">
                  My Profile
                </Link>
              </div>
            )}
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4">
            <div className="bg-white p-4 sm:p-5 rounded-lg shadow hover:shadow-md transition">
              <div className="flex flex-col sm:flex-row items-center sm:items-start">
                <div className="bg-blue-100 text-blue-700 p-3 rounded-lg mb-3 sm:mb-0 sm:mr-4">
            ...
            <div className="bg-white p-4 sm:p-5 rounded-lg shadow hover:shadow-md transition">
              <div className="flex flex-col sm:flex-row items-center sm:items-start">
                <div className="bg-green-100 text-green-700 p-3 rounded-lg mb-3 sm:mb-0 sm:mr-4">
                  <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            ...
            <div className="bg-white p-4 sm:p-5 rounded-lg shadow hover:shadow-md transition">
              <div className="flex flex-col sm:flex-row items-center sm:items-start">
                <div className="bg-purple-100 text-purple-700 p-3 rounded-lg mb-3 sm:mb-0 sm:mr-4">
                  <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                ...
                <div className="text-center sm:text-left">
                  ...
                  <p className="text-gray-600 text-sm">Schedule exams and get automated reminders.</p>
                  <Link to="/tasks" className="text-purple-700 font-medium text-sm mt-2 inline-block">Manage Tasks →</Link>
                </div>
              </div>
            </div>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-3 sm:gap-4">
            {[
              ...
              <Link key={index} to={index === 0 ? "sales" : index === 1 ? "/tasks" : index === 2 ? "sales-tracking" : "/profile"} 
                className="bg-gray-50 rounded-lg p-3 sm:p-4 text-center hover:bg-gray-100 transition">
                <div className="text-xl sm:text-2xl mb-1">{stat.icon}</div>
                <div className="text-base sm:text-lg font-bold">{stat.label}</div>
                <div className="text-xs sm:text-sm text-gray-600">{stat.value}</div>
              </Link>
            ))}
          </div>
        </div>
      ...
      <div className="bg-gray-50 py-8 sm:py-10">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="text-xl sm:text-2xl font-bold mb-4 sm:mb-6 text-center">Your Role: {user?.role || "Not Logged In"}</h2>
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4">
            <div className="bg-white p-4 sm:p-5 rounded-lg shadow">
              <h3 className="font-bold text-blue-700 mb-2 text-center sm:text-left">Lead Person</h3>
            ...
            <div className="bg-white p-4 sm:p-5 rounded-lg shadow">
              <h3 className="font-bold text-green-700 mb-2 text-center sm:text-left">Sales Person</h3>
              <ul className="space-y-2">
                <li className="flex items-start text-sm">
                  <svg className="h-4 w-4 text-green-500 mr-2 mt-0.5 flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />
            ...
            <div className="bg-white p-4 sm:p-5 rounded-lg shadow">
              <h3 className="font-bold text-purple-700 mb-2 text-center sm:text-left">Manager/Admin</h3>
              <ul className="space-y-2">
                <li className="flex items-start text-sm">
                  <svg className="h-4 w-4 text-green-500 mr-2 mt-0.5 flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />
