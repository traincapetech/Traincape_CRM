...
import { FaHome, FaUser, FaUsers, FaChartLine, FaClipboardList, FaChartBar, FaCog, FaFileImport, FaCalendarCheck } from 'react-icons/fa';
      ...
      <div className="flex flex-col h-full">
        ...
        <nav className="flex-1 px-2 py-4">
          <ul className="space-y-2">
            ...
            {/* Update Sales - Only visible to Lead Person, Manager, and Admin */}
            {(user?.role === 'Lead Person' || user?.role === 'Manager' || user?.role === 'Admin') && (
              <li>
                <Link
                  to="/update-sales"
